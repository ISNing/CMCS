...
- 9. 选择上方工具栏中的版本，点击重设远端，输入`git@git.dev.tencent.com:SF2005/CMCS.git`并确定
- 10. 再次点击上方工具栏中的版本，点击拉取
- 11. 等待页面右上角弹出Success字样，在下方终端中输入`./gettingReady.sh`并回车，按提示进行
- 12. 自行检查是否报错并寻找解决方法(正常不会)
- 13. 打开左侧文件树中`CMCS.config`，按照提示与之前准备~~下锅(停不下来))~~的页面信息填入。
